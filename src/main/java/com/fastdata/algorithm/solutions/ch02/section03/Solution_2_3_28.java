 ...
 * @Date: 5/18/21 10:50 AM
 * @Version: 1.0
 * @Description:
 **/

public class Solution_2_3_28 {
    ...
    private static void doExperiment(Map<Integer, Comparable[]> allInputArrays) {
        ...
        for (int cutoffSize: cutoffSizes) {
            for (int i = 0; i < NUMBER_OF_EXPERIMENTS; i ++) {
                ...
                int averageRecursiveDepth = totalRecursionDepth / numberOfRecursiveCalls;
                printResults(cutoffSize, originalArray.length, averageRecursiveDepth);
